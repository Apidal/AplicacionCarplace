...
public interface ISAUsuario {
	...
	/**
	 * Recibe un usuario, comprueba que todos los datos sean correctos y le da de alta
	 * @param usuario
	...
	/**
	 * Recibe un usuario con los datos a modificar, si los datos introducidos son correctos
	 * lo modifica
	 * @param usuario
